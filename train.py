...
if __name__ == "__main__":
    ...
    parser.add_argument('--lrf', default=0.01, required=False, type=float)
    ...
    parser.add_argument('--box', default=7.5, required=False, type=float)
    parser.add_argument('--cls', default=0.5, required=False, type=float)
    ...
    if args.pretrain is not None:
        if args.pretrain == 'coco':
            ...
            elif "m6doc-docbank-wohead" in args.pretrain:
                pretrain_name = 'm6doc-docbank-wohead'
            elif "m6doc-roboflow-wohead" in args.pretrain:
                pretrain_name = 'm6doc-roboflow-wohead'
            elif "m6doc-wohead" in args.pretrain:
                pretrain_name = 'm6doc-wohead'
            elif "docbank-wohead" in args.pretrain:
                pretrain_name = 'docbank-wohead'
            else:
