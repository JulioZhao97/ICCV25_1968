...
from doclayout_yolo.utils import LOGGER, TryExcept, ops, plt_settings, threaded
...
class Colors:
    """
    Ultralytics default color palette https://doclayout_yolo.com/.
...
@TryExcept()  # known issue https://github.com/doclayout_yolo/yolov5/issues/5395
@plt_settings()
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/doclayout_yolo/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from doclayout_yolo.utils.plotting import plot_results
